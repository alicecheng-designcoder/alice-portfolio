...
*文件最後更新：2026-04-29 | 新增「三、全站設計規範」（字體 + 全站顏色系統）；補充「四-3」完整 Nav HTML；新增「八、Footer / Contact HTML 結構」；新增「九、多頁面共用元件維護策略」（Web Components）；建立 `shared-components.js`，已套用至 `article-page-template.html`、兩篇已發布文章、`index.html`*
